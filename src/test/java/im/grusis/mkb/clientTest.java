...
public class clientTest {
  ...
  public void generateKeyTest() {
    Client client = new Client();
    String str = "UlwGCB1DCgRfERYSWUYKBVsCRwQAWAUFBVQBAQRQClIBVAwAUQUDBFMHVAhUDAcBWgBWDgZVBwMAURUDR1wCXxEBFwkVCgMMXxFXBVsDAgZQDFMEA1gABQxbBggCUABVAV4DClEJBwVRBV8CVgQFDlcaXkUJUA8STUAMSw5VCl8RVwwDUQcBA10DUgdWDQYBUg1VAQdSBwcHVQYBA1IEUQtTBQBVBgIARwgb";
    BigInteger random = new BigInteger("98255119643918749234664962155133600351");
    String result = client.generateKey(str, random);
