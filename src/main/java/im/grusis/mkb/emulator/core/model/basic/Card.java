...
public class Card {
  ...
  public void setHpArray(int[] hpArray) {
    HpArray = hpArray;
  }
  ...
  public void setAttackArray(int[] attackArray) {
  ...
  public void setExpArray(long[] expArray) {
    ExpArray = expArray;
  }
}
