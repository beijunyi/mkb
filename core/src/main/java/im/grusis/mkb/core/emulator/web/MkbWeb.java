package im.grusis.mkb.core.emulator.web;
...
import im.grusis.mkb.core.emulator.web.model.request.PassportRequest;
...
public class MkbWeb {
  ...
  private static final Logger Log = LoggerFactory.getLogger(MkbWeb.class);
